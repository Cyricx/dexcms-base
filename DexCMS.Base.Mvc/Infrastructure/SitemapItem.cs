...
namespace DexCMS.Base.Infrastructure
{
    ...
    public class SitemapItem : ISitemapItem
    {
        ...
        public SitemapItem(string url, DateTime? lastModified = null, SEOChangeFrequency? changeFrequency = null, double? priority = null)
        {
            Url = url;
        ...
        /// </summary>
        public SEOChangeFrequency? ChangeFrequency { get; protected set; }
